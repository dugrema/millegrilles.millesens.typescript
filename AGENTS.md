...
+ The API to the MilleGrilles back-end is used through the web service loaded from `app/workers/connection.worker.ts`, MilleGrilles types are in `app/types/connection.types.ts`.
